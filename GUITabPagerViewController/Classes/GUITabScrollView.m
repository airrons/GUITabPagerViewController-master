...
- (void)addIndicatorsToContentView:(UIView *)contentView withColor:(UIColor *)color {
  ...
  self.indicatorCenterConstraint =
    ...
    NSLayoutConstraint * indicatorHeightConstraint = [NSLayoutConstraint constraintWithItem:tabIndicator attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeNotAnAttribute multiplier:1.0 constant:1.5];

  [contentView addConstraints:@[self.indicatorCenterConstraint, self.indicatorWidthConstraint,indicatorHeightConstraint]];
}
